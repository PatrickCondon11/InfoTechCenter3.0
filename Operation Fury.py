...
def gas_level_alert():
    if gas_level_indicator == "Empty":
        ...
        elif street_name_list == "m-89":
            print("The closest gas station is a", list_of_gas_stations(), "gas station", miles_to_gas_station,
                  "miles away on m -", michigan_highway_number)
        elif street_name_list == ("10th st" and street_number <= 3):
            print("The closest gas station is a", list_of_gas_stations(), "gas station", miles_to_gas_station,
                  "miles away on", street_number, "th St")
        elif street_name_list == ("10th st" and street_number == 3):
            print("The closest gas station is a", list_of_gas_stations(), "gas station", miles_to_gas_station,
                  "miles away on", street_number, "rd St")
        elif street_name_list == ("10th st" and street_number == 2):
            print("The closest gas station is a", list_of_gas_stations(), "gas station", miles_to_gas_station,
                  "miles away on", street_number, "nd St")
        elif street_name_list == ("10th st" and street_number == 1):
            print("The closest gas station is a", list_of_gas_stations(), "gas station", miles_to_gas_station,
                  "miles away on", street_number, "st St")
